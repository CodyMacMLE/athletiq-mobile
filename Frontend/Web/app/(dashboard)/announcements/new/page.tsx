        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              maxLength={100}
              className="w-full px-4 py-3 bg-white/8 border border-white/8 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6c5ce7]"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={6}
              className="w-full px-4 py-3 bg-white/8 border border-white/8 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6c5ce7] resize-none"
            />
              ...
              <button
                ...
                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                  targetType === "ALL_TEAMS"
                    ...
                    : "border-white/8 bg-white/8 hover:border-white/10"
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg border-2 font-medium transition-all flex items-center justify-center gap-2 ${
                  sendMode === "now"
                    ...
                    : "border-white/8 bg-white/8 text-white/55 hover:border-white/10"
                }`}
              >
          ...
          <div className="flex gap-3 pt-4">
            <Link
              href="/announcements"
              className="flex-1 px-6 py-3 bg-white/8 hover:bg-white/12 rounded-lg font-medium transition-colors text-center"
            >
              Cancel
            </Link>
            <button
              type="submit"
              disabled={isDisabled}
              className="flex-1 px-6 py-3 bg-[#6c5ce7] hover:bg-[#5a4dd4] disabled:bg-white/8 disabled:cursor-not-allowed rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
              {sendMode === "schedule" ? (
                <>
                  <Clock className="w-4 h-4" />
