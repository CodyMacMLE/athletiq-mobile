    ...
    <div>
      ...
      {activeTab === "attendance" && (
        <div className="bg-white/[0.08] rounded-xl border border-white/[0.08]">
          ...
          <div className="px-6 py-4 border-b border-white/[0.08] flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white/[0.08] border border-white/[0.10] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6c5ce7] text-sm"
              />
            </div>
            <div className="relative">
              <select
                ...
                className="px-4 py-2 bg-white/[0.08] border border-white/[0.10] rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#6c5ce7] appearance-none pr-9 text-sm"
              >
